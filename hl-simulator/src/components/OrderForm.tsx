...
export function OrderForm({
  ...
  return (
    <div className="flex flex-col bg-s1">
      {/* Cross | 10x | Classic - compact HL style */}
      <div className="flex border-b border-brd">
        ...
        <button
          className="flex-1 py-2 text-[13px] font-medium text-center border-r border-brd text-acc"
        >
          {leverage}x
        </button>
        <button
          ...
          <div>
            ...
            <div className="flex items-center bg-transparent border border-brd rounded px-3 focus-within:border-acc transition-colors">
              <input
                ...
                placeholder="0.00"
                className="flex-1 bg-transparent py-1.5 text-[13px] font-medium outline-none font-tabular text-t1"
              />
          ...
          <div className="flex justify-between mt-1">
            {[0, 25, 50, 75, 100].map((pct) => (
              <button
                ...
                className={cn(
                  "text-[9px] font-medium py-0.5 px-1 rounded transition-colors",
