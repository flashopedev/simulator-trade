...
const SYMBOL_MAP: Record<string, string> = {
  ...
  WIF: "MEXC:WIFUSDT", PEPE: "BINANCE:PEPEUSDT", JUP: "BINANCE:JUPUSDT",
  TIA: "BINANCE:TIAUSDT", SEI: "BINANCE:SEIUSDT", INJ: "BINANCE:INJUSDT",
  RENDER: "BINANCE:RENDERUSDT", FET: "BINANCE:FETUSDT", ONDO: "BINANCE:ONDOUSDT",
  STX: "BINANCE:STXUSDT", NEAR: "BINANCE:NEARUSDT", BONK: "BINANCE:BONKUSDT",
  // Tradifi — stocks
  "xyz:TSLA": "NASDAQ:TSLA", "xyz:NVDA": "NASDAQ:NVDA", "xyz:AAPL": "NASDAQ:AAPL",
  "xyz:MSFT": "NASDAQ:MSFT", "xyz:GOOGL": "NASDAQ:GOOGL", "xyz:AMZN": "NASDAQ:AMZN",
  "xyz:META": "NASDAQ:META", "xyz:HOOD": "NASDAQ:HOOD", "xyz:PLTR": "NYSE:PLTR",
  "xyz:COIN": "NASDAQ:COIN", "xyz:INTC": "NASDAQ:INTC", "xyz:AMD": "NASDAQ:AMD",
  "xyz:MU": "NASDAQ:MU", "xyz:SNDK": "NASDAQ:WDC", "xyz:MSTR": "NASDAQ:MSTR",
  "xyz:CRCL": "NYSE:CRCL", "xyz:NFLX": "NASDAQ:NFLX", "xyz:ORCL": "NYSE:ORCL",
  "xyz:TSM": "NYSE:TSM", "xyz:BABA": "NYSE:BABA", "xyz:RIVN": "NASDAQ:RIVN",
  "xyz:CRWV": "NASDAQ:CRWV", "xyz:USAR": "AMEX:ITA", "xyz:URNM": "AMEX:URNM",
  // Tradifi — index
  "xyz:XYZ100": "NASDAQ:QQQ",
  // Tradifi — commodities
  "xyz:GOLD": "TVC:GOLD", "xyz:SILVER": "TVC:SILVER", "xyz:CL": "NYMEX:CL1!",
  "xyz:COPPER": "COMEX:HG1!", "xyz:NATGAS": "NYMEX:NG1!", "xyz:PLATINUM": "NYMEX:PL1!",
  // Tradifi — FX
  "xyz:JPY": "FX:USDJPY", "xyz:EUR": "FX:EURUSD",
};
